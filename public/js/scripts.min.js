if (
  "http://html.berserk.nikadevs.com" == window.location.origin ||
  "https://html.berserk.nikadevs.com" == window.location.origin
) {
...
!(function (e, t) {
  ...
  var h = (function (n) {
    ...
    try {
      I.apply((t = O.call(b.childNodes)), b.childNodes),
    ...
    function re(e, t, n, i) {
      ...
      if (
        !i &&
        ((t ? t.ownerDocument || t : b) !== C && k(t), (t = t || C), x)
      ) {
        if (11 !== f && (l = G.exec(e)))
          if ((o = l[1])) {
            if (9 === f) {
            ...
            if (
              ...
              return I.apply(n, t.getElementsByClassName(o)), n;
          }
    ...
    (k = re.setDocument = function (e) {
      ...
      return (
        i !== C &&
          ...
          (h.getElementsByClassName = X.test(C.getElementsByClassName)),
          ...
          (a = []),
          (g = []),
          (h.qsa = X.test(C.querySelectorAll)) &&
            (le(function (e) {
    ...
    ((_ = re.selectors = {
                ...
                if (d) {
                  if (v) {
                    for (; c; ) {
                      for (s = e; (s = s[c]); )
                        if (
                          y ? s.nodeName.toLowerCase() === u : 1 === s.nodeType
                        )
                          return !1;
      ...
      pseudos: {
        ...
        lang: ae(function (n) {
          return (
            K.test(n || "") || re.error("unsupported lang: " + n),
      ...
      return (
        ...
        ae(function (e, t, n, i) {
          var o,
            ...
            f = m ? (v || (e ? h : c || g) ? [] : t) : u;
          if ((m && m(u, f, n, i), g))
            for (o = _e(f, l), g(o, [], n, i), r = o.length; r--; )
              (s = o[r]) && (f[l[r]] = !(u[l[r]] = s));
          if (e) {
            if (v || h) {
              if (v) {
    ...
    return (
          ...
          (s = E(
            ...
            (i = function (e, t, n, i, o) {
              ...
              for (
                ...
                if (y && r) {
                  for (
                    s = 0, t || r.ownerDocument === C || (k(r), (n = !x));
                    (a = g[s++]);
      ...
      (m = re.select = function (e, t, n, i) {
        ...
        if (((n = n || []), 1 === d.length)) {
          ...
          for (
            o = $.needsContext.test(e) ? 0 : r.length;
            ...
            if (
              ...
              (i = l(
                ...
                (J.test(r[0].type) && me(t.parentNode)) || t
              ))
            ) {
      ...
      (h.sortStable = T.split("").sort(S).join("") === T),
  ...
  (T.filter = function (e, t, n) {
    ...
    T.fn.extend({
      ...
      is: function (e) {
        return !!A(this, "string" == typeof e && j.test(e) ? T(e) : e || [], !1)
          .length;
      },
    });
  var D,
  ...
  ((T.fn.init = function (e, t, n) {
    ...
    if (i[1]) {
      if (
        ...
        T.merge(
          this,
          T.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : x, !0)
        ),
    ...
    return (
      (o = x.getElementById(i[2])) && ((this[0] = o), (this.length = 1)), this
    );
  }).prototype = T.fn),
    (D = T(x));
      ...
      function (i, o) {
        T.fn[i] = function (e, t) {
          ...
          return (
            ...
            1 < this.length &&
              (O[i] || T.uniqueSort(n), I.test(i) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
  ...
  (T.Callbacks = function (i) {
    ...
    T.extend({
          ...
          s = {
            ...
            then: function (t, n, i) {
                    ...
                    e = function () {
                      ...
                      if (!(o < l)) {
                        ...
                        (t =
                          ...
                          b(t)
                            ? a
                              ? t.call(e, c(l, r, P, a), c(l, r, H, a))
                              : (l++,
                                t.call(
                                  e,
                                  c(l, r, P, a),
                                  c(l, r, H, a),
                                  c(l, r, P, r.notifyWith)
                                ))
                            : (s !== P && ((n = void 0), (i = [e])),
                              (a || r.resolveWith)(n, i));
                      }
              ...
              return T.Deferred(function (e) {
                r[0][3].add(c(0, e, b(i) ? i : P, e.notifyWith)),
                  r[1][3].add(c(0, e, b(t) ? t : P)),
      ...
      when: function (e) {
        ...
        if (
          n <= 1 &&
          (W(e, r.done(s(t)).resolve, r.reject, !n),
          "pending" === r.state() || b(o[t] && o[t].then))
        )
          return r.then();
  ...
  T.extend({
    ...
    T.fn.extend({
      data: function (n, e) {
        ...
        if (
          this.length &&
          ((o = X.get(r)), 1 === r.nodeType && !Y.get(r, "hasDataAttrs"))
        ) {
          for (t = s.length; t--; )
            s[t] &&
            ...
            "" === i.style.display &&
              ...
              (o[r] =
                ...
                (u = se[d]) ||
                  ...
                  "none" === u && (u = "block"),
                  (se[d] = u)))))
          : "none" !== n && ((o[r] = "none"), Y.set(i, "display", n)));
    var a, l, c, d, u;
      ...
      if (g && (l = g.events)) {
        for (c = (t = (t || "").match(L) || [""]).length; c--; )
          if (
            ...
            for (
              u = T.event.special[h] || {},
                f = l[(h = (i ? u.delegateType : u.bindType) || h)] || [],
                a =
                  a[2] &&
                  new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                s = r = f.length;
  ...
  function qe(n, i, o, r) {
    ...
    var e,
      ...
      h = i[0],
      p = b(h);
    if (p || (1 < u && "string" == typeof h && !v.checkClone && Se.test(h)))
    ...
    if (
      ...
      for (a = (s = T.map(fe(e, "script"), Ne)).length; d < u; d++)
        (l = e),
          d !== f &&
            ((l = T.clone(l, !0, !0)), a && T.merge(s, fe(l, "script"))),
          o.call(n[d], l, d);
      if (a)
        for (c = s[s.length - 1].ownerDocument, T.map(s, Ie), d = 0; d < a; d++)
          (l = s[d]),
            de.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : _(l.textContent.replace(Ae, ""), c, l));
    }
    return n;
  }
  function Le(e, t, n) {
    for (var i, o = t ? T.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || T.cleanData(fe(i)),
        i.parentNode &&
          (n && T.contains(i.ownerDocument, i) && he(fe(i, "script")),
  ...
  T.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (s = fe(d), i = 0, o = (r = fe(e)).length; i < o; i++)
          (a = r[i]),
            (l = s[i]),
            void 0,
      ...
      if (t)
        if (n)
          for (r = r || fe(e), s = s || fe(d), i = 0, o = r.length; i < o; i++)
            Oe(r[i], s[i]);
        else Oe(e, d);
      return (
        0 < (s = fe(d, "script")).length && he(s, !u && fe(e, "script")), d
      );
    },
      ...
      replaceWith: function () {
        ...
        return qe(
          ...
          function (e) {
            ...
            T.inArray(this, n) < 0 &&
              (T.cleanData(fe(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          c = e.style;
        if (
          (l || (t = $e(a)), (s = T.cssHooks[t] || T.cssHooks[a]), void 0 === n)
        )
  ...
  function lt(r, e, t) {
    ...
    for (
      ...
      if ((n = lt.prefilters[i].call(c, r, d, c.opts)))
        return (
          b(n.stop) &&
  ...
  (T.Animation = T.extend(lt, {
    ...
    tweener: function (e, t) {
      for (
        var n, i = 0, o = (e = b(e) ? ((t = e), ["*"]) : e.match(L)).length;
        i < o;
        i++
      )
        (n = e[i]),
        ...
        if ((l = !T.isEmptyObject(t)) || !T.isEmptyObject(h))
          ...
          h))
            l ||
              ...
              m && ae([e], !0),
              f.done(function () {
                for (i in (m || ae([e]), Y.remove(e, "fxshow"), h))
                  T.style(e, i, h[i]);
              })),
              (l = at(m ? g[i] : 0, i, f)),
              i in g ||
              ...
              if (s)
                ...
                (void 0 !== o && "boolean" !== r) ||
                  ...
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      e || !1 === o ? "" : Y.get(this, "__className__") || ""
                    ));
            });
      },
      hasClass: function (e) {
  ...
  T.extend(T.event, {
    trigger: function (e, t, n, i) {
      ...
      if (
        ...
        if (!i && !d.noBubble && !y(n)) {
          for (
            a = d.delegateType || h, vt.test(a + h) || (r = r.parentNode);
            r;
            r = r.parentNode
          )
            f.push(r), (s = r);
        ...
        for (o = 0; (r = f[o++]) && !e.isPropagationStopped(); )
          (u = r),
            ...
            (c = (Y.get(r, "events") || {})[e.type] && Y.get(r, "handle")) &&
              c.apply(r, t),
            (c = l && r[l]) &&
              c.apply &&
              $(r) &&
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              ((s = n[l]) && (n[l] = null),
              (T.event.triggered = h),
              e.isPropagationStopped() && u.addEventListener(h, bt),
              n[h](),
              e.isPropagationStopped() && u.removeEventListener(h, bt),
  ...
  function jt(n, e, i, o) {
    ...
    else for (t in e) jt(n + "[" + t + "]", e[t], i, o);
  }
    ...
    T.extend({
      ...
      ajax: function (e, t) {
        ...
        g.hasContent
          ...
          : ((r = g.url.slice(u.length)),
            g.data &&
              ...
              ((u += (wt.test(u) ? "&" : "?") + g.data), delete g.data),
            !1 === g.cache &&
              ((u = u.replace(At, "$1")),
              (r = (wt.test(u) ? "&" : "?") + "_=" + _t++ + r)),
            (g.url = u + r)),
        ...
        if (
          ...
          if (((k.readyState = 1), m && b.trigger("ajaxSend", [k, g]), p))
            return k;
          g.async &&
            0 < g.timeout &&
        ...
        function c(e, t, n, i) {
          ...
          p ||
            ...
            o
              ? (g.ifModified &&
                  ((l = k.getResponseHeader("Last-Modified")) &&
                    (T.lastModified[u] = l),
                  (l = k.getResponseHeader("etag")) && (T.etag[u] = l)),
                204 === e || "HEAD" === g.type
                  ? (c = "nocontent")
                  : 304 === e
                  ? (c = "notmodified")
            ...
            (k.status = e),
            (k.statusText = (t || c) + ""),
            o ? y.resolveWith(v, [r, c, k]) : y.rejectWith(v, [k, c, s]),
            k.statusCode(w),
            (w = void 0),
            m && b.trigger(o ? "ajaxSuccess" : "ajaxError", [k, g, o ? r : s]),
            _.fireWith(v, [k, c]),
            m &&
              (b.trigger("ajaxComplete", [k, g]),
  ...
  T.ajaxSetup({
    ...
    T.each(["top", "left"], function (e, n) {
      T.cssHooks[n] = Me(v.pixelPosition, function (e, t) {
        if (t)
          return (t = Be(e, n)), Pe.test(t) ? T(e).position()[n] + "px" : t;
      });
    }),
  ...
  (function (e, t) {
    ...
    function f(e, t, n, i) {
      var o,
        ...
        f = k(e, t);
      if ("viewport" === i)
        (r = (o = f).ownerDocument.documentElement),
          (s = E(o, r)),
          (a = H(r.clientWidth, window.innerWidth || 0)),
          (l = H(r.clientHeight, window.innerHeight || 0)),
          (c = C(r)),
          (d = C(r, "left")),
          (u = T({
        ...
        if (
          ...
          var m = x(),
            g = m.height,
            v = m.width;
          (u.top += p.top - p.marginTop),
            (u.bottom = g + p.top),
            (u.left += p.left - p.marginLeft),
            (u.right = v + p.left);
        }
      }
    ...
    var B,
      ...
      z = function () {
        return (
          null == B && (B = -1 !== navigator.appVersion.indexOf("MSIE 10")), B
        );
      },
      R = (function () {
        function i(e, t) {
      ...
      X = (function () {
        function r(e, t) {
          ...
          (function (e, t) {
            ...
            Object.keys(U({}, r.Defaults.modifiers, i.modifiers)).forEach(
              function (e) {
          ...
          arrow: {
            ...
            fn: function (e, t) {
              ...
              var o = e.placement.split("-")[0],
                ...
                h = l ? "bottom" : "right",
                p = S(i)[c];
              a[h] - p < s[u] && (e.offsets.popper[u] -= s[u] - (a[h] - p)),
                a[u] + p > s[h] && (e.offsets.popper[u] += a[u] + p - s[h]),
                ...
                _.forEach(function (e, t) {
                  ...
                  (s || u || h) &&
                    ...
                    (p.offsets.popper = U(
                      {},
                      p.offsets.popper,
                      D(p.instance.popper, p.offsets.reference, p.placement)
                    )),
                    (p = I(p.instance.modifiers, p, "flip")));
                }),
                p
              );
            },
          ...
          computeStyle: {
            ...
            fn: function (e, t) {
              ...
              if (
                ...
                (s = "right" == h ? -c.width + u.right : u.left),
                l && p)
              )
                (d[p] = "translate3d(" + s + "px, " + a + "px, 0)"),
                  (d[f] = 0),
                  (d[h] = 0),
              ...
              return (
                (e.attributes = U({}, v, e.attributes)),
                (e.styles = U({}, d, e.styles)),
  ...
  (function (e, t) {
    ...
    p(document).on(
      ...
      (p.fn[n] = d._jQueryInterface),
      (p.fn[n].Constructor = d),
        ...
        return (
          ...
          (e.to = function (e) {
            ...
            if (!(e > this._items.length - 1 || e < 0))
              if (this._isSliding)
                p(this._element).one(I.SLID, function () {
                  return t.to(e);
                });
              else {
          ...
          (e._addEventListeners = function () {
            ...
            this._config.keyboard &&
              p(this._element).on(I.KEYDOWN, function (e) {
                return t._keydown(e);
              }),
              "hover" === this._config.pause &&
                p(this._element)
                  .on(I.MOUSEENTER, function (e) {
                    return t.pause(e);
                  })
          ...
          (e._addTouchEventListeners = function () {
            ...
            if (this._touchSupported) {
              ...
              p(this._element.querySelectorAll(".carousel-item img")).on(
                ...
                this._pointerEvent
                  ? (p(this._element).on(I.POINTERDOWN, function (e) {
                      return t(e);
                    }),
                  ...
                  : (p(this._element).on(I.TOUCHSTART, function (e) {
                      return t(e);
                    }),
          ...
          (r._jQueryInterface = function (i) {
            return this.each(function () {
              ...
              if (
                (e || ((e = new r(this, t)), p(this).data(x, e)),
                "number" == typeof i)
              )
                e.to(i);
    ...
    p(document).on(
      ...
      p(window).on(I.LOAD_DATA_API, function () {
        for (
          var e = [].slice.call(
      ...
      (p.fn[C] = P._jQueryInterface),
      (p.fn[C].Constructor = P),
    ...
    var H = "collapse",
      ...
      Y = (function () {
        ...
        return (
          ...
          (e.show = function () {
            ...
            if (
              ...
              if ((p(this._element).trigger(i), !i.isDefaultPrevented())) {
                ...
                p(this._element).removeClass(Q).addClass(K),
                ...
                p(this._element)
                  .one(m.TRANSITION_END, function () {
                    p(n._element).removeClass(K).addClass(Q).addClass(U),
                      (n._element.style[o] = ""),
                      n.setTransitioning(!1),
                      p(n._element).trigger(F.SHOWN);
                  })
            ...
            if (!this._isTransitioning && p(this._element).hasClass(U)) {
              ...
              if ((p(this._element).trigger(t), !t.isDefaultPrevented())) {
                ...
                (this._element.style[n] =
                  ...
                  p(this._element).addClass(K).removeClass(Q).removeClass(U);
                  ...
                  for (var o = 0; o < i; o++) {
                    ...
                    null !== s &&
                      (p([].slice.call(document.querySelectorAll(s))).hasClass(
                        ...
                        p(r).addClass($).attr("aria-expanded", !1));
                  }
          ...
          (e._getConfig = function (e) {
            return (
              ((e = l({}, z, e)).toggle = Boolean(e.toggle)),
              m.typeCheckConfig(H, e, R),
              e
            );
          }),
    ...
    p(document).on(F.CLICK_DATA_API, V, function (e) {
      ...
      (p.fn[H] = Y._jQueryInterface),
      (p.fn[H].Constructor = Y),
        ...
        return (
              ...
              if ((c._clearMenus(), !t)) {
                ...
                if ((p(e).trigger(i), !i.isDefaultPrevented())) {
                  ...
                  "ontouchstart" in document.documentElement &&
                    ...
                    p(this._menu).toggleClass(oe),
                    p(e).toggleClass(oe).trigger(p.Event(ne.SHOWN, n));
                }
              }
            }
          }),
            ...
            if (
              ...
              p(n).trigger(t),
                t.isDefaultPrevented() ||
                  (p(this._menu).toggleClass(oe),
                  p(n).toggleClass(oe).trigger(p.Event(ne.SHOWN, e)));
            }
          }),
          (e.hide = function () {
            if (
              ...
              p(n).trigger(t),
                t.isDefaultPrevented() ||
                  (p(this._menu).toggleClass(oe),
                  p(n).toggleClass(oe).trigger(p.Event(ne.HIDDEN, e)));
            }
          }),
          (e.dispose = function () {
          ...
          (e._getConfig = function (e) {
            return (
              ...
              m.typeCheckConfig(X, e, this.constructor.DefaultType),
              e
            );
          }),
          ...
          (e._getPlacement = function () {
            ...
            return (
              e.hasClass("dropup")
                ? ((t = "top-start"),
                  p(this._menu).hasClass(re) && (t = "top-end"))
                : e.hasClass("dropright")
                ? (t = "right-start")
                : e.hasClass("dropleft")
                ? (t = "left-start")
                : p(this._menu).hasClass(re) && (t = "bottom-end"),
              t
            );
          }),
                  ...
                  if (
                    ...
                    p(o).trigger(l),
                      l.isDefaultPrevented() ||
                        ...
                        p(a).removeClass(oe),
                        p(o).removeClass(oe).trigger(p.Event(ne.HIDDEN, s)));
                  }
                }
              }
          }),
    ...
    p(document)
      ...
      (p.fn[X] = de._jQueryInterface),
      (p.fn[X].Constructor = de),
        ...
        return (
          ...
          (e._hideModal = function () {
            ...
            (this._element.style.display = "none"),
              ...
              (this._isTransitioning = !1),
              this._showBackdrop(function () {
                p(document.body).removeClass(be),
                  e._resetAdjustments(),
                  e._resetScrollbar(),
          ...
          (o._jQueryInterface = function (n, i) {
            return this.each(function () {
              ...
              if (
                (e || ((e = new o(this, t)), p(this).data(fe, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    p(document).on(ve.CLICK_DATA_API, '[data-toggle="modal"]', function (e) {
      ...
      var r = p(t).one(ve.SHOW, function (e) {
        e.isDefaultPrevented() ||
          r.one(ve.HIDDEN, function () {
            p(n).is(":visible") && n.focus();
          });
      });
      Ce._jQueryInterface.call(p(t), o, this);
    }),
      (p.fn[ue] = Ce._jQueryInterface),
      (p.fn[ue].Constructor = Ce),
            ...
            o.forEach(function (e) {
              (function (e, t) {
                ...
                if (-1 !== t.indexOf(n))
                  return (
                    -1 === xe.indexOf(n) ||
                    Boolean(e.nodeValue.match(Te) || e.nodeValue.match(je))
                  );
                for (
        ...
        return (
          ...
          (e.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              o.setAttribute("id", r),
                ...
                this.setContent(),
                this.config.animation && p(o).addClass(Me);
              var s =
          ...
          (e.setContent = function () {
            ...
            this.setElementContent(
              ...
              p(e).removeClass(Me + " " + ze);
          }),
          (e.setElementContent = function (e, t) {
            "object" != typeof t || (!t.nodeType && !t.jquery)
              ? this.config.html
                ? (this.config.sanitize &&
                    (t = Ee(t, this.config.whiteList, this.config.sanitizeFn)),
                  e.html(t))
                : e.text(t)
              : this.config.html
          ...
          (e._enter = function (e, t) {
            ...
            (t = t || p(e.currentTarget).data(n)) ||
              ...
              p(t.getTipElement()).hasClass(ze) || t._hoverState === We
                ? (t._hoverState = We)
          ...
          (e._getConfig = function (e) {
            ...
            return (
              ...
              m.typeCheckConfig(Se, e, this.constructor.DefaultType),
              e.sanitize &&
                (e.template = Ee(e.template, e.whiteList, e.sanitizeFn)),
              e
            );
          }),
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                ...
                (e || ((e = new i(this, t)), p(this).data(Ae, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (p.fn[Se] = Ue._jQueryInterface),
      (p.fn[Se].Constructor = Ue),
      (p.fn[Se].noConflict = function () {
        ...
        return (
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (e || !/dispose|hide/.test(n)) &&
                (e || ((e = new i(this, t)), p(this).data(Ke, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (p.fn[Qe] = et._jQueryInterface),
      (p.fn[Qe].Constructor = et),
      (p.fn[Qe].noConflict = function () {
      ...
      ht = (function () {
        ...
        return (
          ...
          (e._getConfig = function (e) {
            if (
              "string" !=
              typeof (e = l({}, rt, "object" == typeof e && e ? e : {})).target
            ) {
            ...
            n.hasClass("dropdown-item")
              ...
              : (n.addClass(lt),
                n
                  ...
                  .prev(dt + ", " + ut)
                  .addClass(lt),
                n.parents(ct).prev(".nav-item").children(dt).addClass(lt)),
    ...
    var kt = "toast",
      ...
      Nt = (function () {
        ...
        return (
          (e.show = function () {
            var e = this;
            p(this._element).trigger(jt.SHOW),
              this._config.animation && this._element.classList.add("fade");
            var t = function () {
              e._element.classList.remove(St),
                e._element.classList.add(Et),
                p(e._element).trigger(jt.SHOWN),
          ...
          (e.hide = function (e) {
            ...
            this._element.classList.contains(Et) &&
              (p(this._element).trigger(jt.HIDE),
              e
                ? this._close()
          ...
          (e.dispose = function () {
            clearTimeout(this._timeout),
              ...
              p(this._element).off(jt.CLICK_DISMISS),
          ...
          (e._getConfig = function (e) {
            return (
              ...
              m.typeCheckConfig(kt, e, this.constructor.DefaultType),
              e
            );
          }),
          (e._setListeners = function () {
            ...
            var e = this,
              t = function () {
                e._element.classList.add("hide"),
                  p(e._element).trigger(jt.HIDDEN);
              };
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (t ||
                  ((t = new i(this, "object" == typeof n && n)), e.data(Ct, t)),
                "string" == typeof n)
              ) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (p.fn[kt] = Nt._jQueryInterface),
      (p.fn[kt].Constructor = Nt),
        ...
        (e = {
          ...
          for (var s in this.waypoints[o]) {
            ...
            u.element !== u.element.window &&
              (p = u.adapter.offset()[r.offsetProp]),
              "function" == typeof f
                ? (f = f.apply(u))
                : "string" == typeof f &&
                  ((f = parseFloat(f)),
    ...
    (t = (function () {
      ...
      (this.WOW = (function () {
        ...
        return (
          ...
          (e.prototype.vendorSet = function (o, e) {
            var r, t, s, a;
            for (r in ((t = []), e))
              (s = e[r]),
                (o["" + r] = s),
                  ...
                  function () {
                    ...
                    for (
                      ...
                      (a = n[e]),
                        i.push(
                          (o[
                            "" + a + r.charAt(0).toUpperCase() + r.substr(1)
                          ] = s)
                        );
                    return i;
                  }.call(this)
        ...
        function (e) {
          ...
          e.detail.instance == r &&
            (e.defaultPrevented ||
              ...
              (t = e.target.getAttribute("data-link")) && s(t, !0),
              (t = e.target.getAttribute("data-script")) && s(t),
              (t = e.target.getAttribute("data-require")) &&
                (r.cfg.requireJs ? r.cfg.requireJs([t]) : s(t)),
              (n = e.target.getAttribute("data-bg")) &&
                ((e.detail.firesLoad = !0),
                a(n, function () {
                  (e.target.style.backgroundImage =
                    "url(" + (l.test(n) ? JSON.stringify(n) : n) + ")"),
      ...
      if (d.getElementsByClassName) {
        var u,
          ...
          T = function (e, t, n) {
            for (
              n = n || e.offsetWidth;
              n < f.minSize && t && !e._lazysizesWidth;
          ...
          j =
            ...
            ((Te = function (e, t) {
              ye && !t
                ...
                : (Ce.push(e), _e || ((_e = !0), (d.hidden ? m : n)(xe)));
            })._lsFlush = xe = function () {
              var e = Ce;
              for (Ce = we.length ? ke : we, _e = !(ye = !0); e.length; )
                e.shift()();
              ye = !1;
            }),
            Te),
        ...
        var S =
            ((ne = /^img$/i),
            (ie = /^iframe$/i),
            (oe = "onscroll" in i && !/glebot/.test(navigator.userAgent)),
            (ae = -1),
            (le = function (e) {
              se--,
                e && e.target && w(e.target, le),
                (!e || se < 0 || !e.target) && (se = 0);
            }),
            (ce = function (e, t) {
              var n,
                i = e,
                o =
                  "hidden" == x(d.body, "visibility") ||
              ...
              if ((W = f.loadMode) && se < 8 && (e = c.length)) {
                (t = 0),
                  ...
                  null == $ &&
                    ...
                    (K = f.expand),
                    ($ = K * f.expFactor)),
                  re < $ && se < 1 && 2 < ae && 2 < W && !d.hidden
                    ? ((re = $), (ae = 0))
                    : (re = 1 < W && 1 < ae && se < 6 ? K : 0);
                for (; t < e; t++)
                  if (c[t] && !c[t]._lazyRace)
                    if (oe)
                      if (
                        (((a = c[t][p]("data-expand")) && (r = 1 * a)) ||
                          (r = re),
                        l !== r &&
                          ((M = innerWidth + r * V),
                          (z = innerHeight + r),
                        ...
                        (Q = n.bottom) >= s &&
                          ...
                          (F = n.left) <= M &&
                          (Q || U || F || R) &&
                          (f.loadHidden || "hidden" != x(c[t], "visibility")) &&
                          ((P && se < 3 && !a && (W < 3 || ae < 4)) ||
                            ce(c[t], r)))
                      ) {
            ...
            (he = e(
              (fe = function (e) {
                y(e.target, f.loadedClass),
                  _(e.target, f.loadingClass),
                  w(e.target, pe),
            ...
            (me = function (e) {
              var t,
                n = e[p](f.srcsetAttr);
              (t = f.customMedia[e[p]("data-media") || e[p]("media")]) &&
            ...
            (ge = e(function (e, t, n, i, o) {
              ...
              (c = k(e, "lazybeforeunveil", t)).defaultPrevented ||
                (i && (n ? y(e, f.autosizesClass) : e.setAttribute("sizes", i)),
                (s = e[p](f.srcsetAttr)),
                (r = e[p](f.srcAttr)),
                o && ((a = e.parentNode), (l = a && g.test(a.nodeName || ""))),
                ...
                d &&
                  ...
                  y(e, f.loadingClass),
                  w(e, pe, !0)),
                l && v.call(a.getElementsByTagName("source"), me),
                s
            ...
            }),
            {
              _: function () {
                (B = r.now()),
                  ...
                  t("resize", ue, !0),
                  i.MutationObserver
                    ? new MutationObserver(ue).observe(h, {
                        childList: !0,
                        subtree: !0,
                        attributes: !0,
                      })
                    : (h[s]("DOMNodeInserted", ue, !0),
                      h[s]("DOMAttrModified", ue, !0),
                      setInterval(ue, 999)),
                  t("hashchange", ue, !0),
                  [
                    "focus",
                  ...
                  /d$|^c/.test(d.readyState)
                    ? be()
                    : (t("load", be), d[s]("DOMContentLoaded", ue), m(be, 2e4)),
                  u.elements.length ? (de(), j._lsFlush()) : ue();
              },
              checkElems: ue,
              unveil: (ve = function (e) {
                var t,
                  n = ne.test(e.nodeName),
          ...
          A =
            ...
            (O = function (e, t, n) {
              ...
              o &&
                ((n = T(e, o, n)),
                (i = k(e, "lazybeforesizes", { width: n, dataAttr: !!t }))
                  .defaultPrevented ||
                  ((n = i.detail.width) &&
                    n !== e._lazysizesWidth &&
                    I(e, o, i, n)));
            ...
            {
              _: function () {
                (N = d.getElementsByClassName(f.autosizesClass)),
                  t("resize", q);
              },
              checkElems: (q = E(function () {
                var e,
                  t = N.length;
                if (t) for (e = 0; e < t; e++) O(N[e]);
              })),
              updateElem: O,
            }),
          D = function () {
      ...
      return function (t) {
        ...
        !t.defaultPrevented &&
          ...
          ((n = document.createElement("img")).setAttribute(
            "sizes",
            t.target.getAttribute("data-sizes") || t.target.offsetWidth + "px"
          ),
          (i = function () {
            var e = n.currentSrc || n.src;
            e && (t.target.style.backgroundImage = "url(" + e + ")"),
              lazySizes.cfg.clearAttr && t.target.removeAttribute("data-bgset"),
          ...
          window.HTMLPictureElement ||
            (window.respimage
              ? respimage({ elements: [n] })
              : window.picturefill && picturefill({ elements: [n] })),
  ...
  (function (e) {
    ...
    function o(e, t) {
      ...
      void 0 !== this.options.locales[n] &&
        P.extend(this.options, this.options.locales[n]),
        this.init();
    }
    function H(e) {
      if (
        !P(e.target).parents().hasClass("jq-selectbox") &&
        "OPTION" != e.target.nodeName &&
        P("div.jq-selectbox.opened").length
      ) {
        ...
        if (O.is(":checkbox")) {
          var t = function () {
            var e = new I(),
              t = P(
                ...
                .addClass(e.classes)
                .data(e.data);
            O.after(t).prependTo(t),
              O.is(":checked") && t.addClass("checked"),
              O.is(":disabled") && t.addClass("disabled"),
              t.click(function (e) {
                e.preventDefault(),
                  O.triggerHandler("click"),
                  t.is(".disabled") ||
                    (O.is(":checked")
                      ? (O.prop("checked", !1), t.removeClass("checked"))
                      : (O.prop("checked", !0), t.addClass("checked")),
                    O.focus().change());
              }),
              O.closest("label")
                .add('label[for="' + O.attr("id") + '"]')
                .on("click.styler", function (e) {
                  P(e.target).is("a") ||
                    P(e.target).closest(t).length ||
          ...
          var n = function () {
            var e = new I(),
              n = P(
                ...
                .addClass(e.classes)
                .data(e.data);
            O.after(n).prependTo(n),
              O.is(":checked") && n.addClass("checked"),
              O.is(":disabled") && n.addClass("disabled"),
              (P.fn.commonParents = function () {
                var e = this;
                return e
                  .first()
                  .parents()
              ...
              O.closest("label")
                ...
                .on("click.styler", function (e) {
                  P(e.target).is("a") ||
                    ...
                    (n.triggerHandler("click"), e.preventDefault());
                }),
              O.on("change.styler", function () {
            ...
            n && r.text(n.replace(/.+[\\\/]/, "")),
              O.on("change.styler", function () {
                ...
                if (O.is("[multiple]")) {
                  ...
                  if (0 < t) {
                    var n = O.data("number");
                    void 0 === n && (n = q.fileNumber),
                      (e = n = n.replace("%s", t));
                  }
                }
                r.text(e.replace(/.+[\\\/]/, "")),
                  "" === e
                    ? (r.text(i), o.removeClass("changed"))
                    : o.addClass("changed");
              })
                .on("focus.styler", function () {
                  o.addClass("focused");
          ...
          var o = function () {
            ...
            var r,
              ...
              n = null,
              i = null;
            void 0 !== O.attr("min") && (r = O.attr("min")),
              void 0 !== O.attr("max") && (s = O.attr("max")),
              (a =
                void 0 !== O.attr("step") && P.isNumeric(O.attr("step"))
                  ? Number(O.attr("step"))
                  : Number(1));
            var o = function (e) {
              var t,
                n = O.val();
              P.isNumeric(n) || ((n = 0), O.val("0")),
                e.is(".minus")
                  ? (t = Number(n) - a)
                  : e.is(".plus") && (t = Number(n) + a);
              var i = (a.toString().split(".")[1] || []).length;
              if (0 < i) {
                for (var o = "1"; o.length <= i; ) o += "0";
                t = Math.round(t * o) / o;
              }
              P.isNumeric(r) && P.isNumeric(s)
                ? r <= t && t <= s && O.val(t)
                : P.isNumeric(r) && !P.isNumeric(s)
                ? r <= t && O.val(t)
                : !P.isNumeric(r) && P.isNumeric(s)
          ...
          var r = function () {
            ...
            function A() {
              for (var e = 0; e < D.length; e++) {
                ...
                t.prop("selected") && (i = "selected sel"),
                  ...
                  void 0 !== t.attr("id") &&
                    "" !== t.attr("id") &&
                    (r = ' id="' + t.attr("id") + q.idSuffix + '"'),
                  void 0 !== t.attr("title") &&
                    "" !== D.attr("title") &&
                    (s = ' title="' + t.attr("title") + '"'),
                  void 0 !== t.attr("class") &&
                    ((l = " " + t.attr("class")),
            ...
            if (O.is("[multiple]")) {
              ...
              !(function () {
                var e = new I(),
                  t = P('<div class="jq-select-multiple jqselect"></div>')
                    .attr({ id: e.id, title: e.title })
                    .addClass(e.classes)
                    .data(e.data);
                ...
                void 0 !== i && 0 < i
                  ...
                  : n.css({ height: 4 * s }),
                  r > t.height() &&
                    (n.css("overflowY", "scroll"),
                    S(n),
                    o.filter(".selected").length &&
                      n.scrollTop(
                        n.scrollTop() + o.filter(".selected").position().top
                      )),
                  O.prependTo(t),
                  O.is(":disabled")
                    ? (t.addClass("disabled"),
                      D.each(function () {
                        P(this).is(":selected") &&
                          o.eq(P(this).index()).addClass("selected");
                      }))
                    : (o
                        ...
                        .click(function (e) {
                          ...
                          var t = P(this);
                          if (
                            (e.ctrlKey || e.metaKey || t.addClass("selected"),
                            e.shiftKey || t.addClass("first"),
                            e.ctrlKey ||
                              e.metaKey ||
                              e.shiftKey ||
                              t.siblings().removeClass("selected first"),
                            (e.ctrlKey || e.metaKey) &&
                              (t.is(".selected")
                                ? t.removeClass("selected first")
                                : t.addClass("selected first"),
                      ...
                      r > t.height() &&
                        O.on("keydown.styler", function (e) {
                          (38 != e.which && 37 != e.which && 33 != e.which) ||
                            n.scrollTop(
                              n.scrollTop() +
                                o.filter(".selected").position().top -
                                s
                            ),
                            (40 != e.which && 39 != e.which && 34 != e.which) ||
                              n.scrollTop(
                                n.scrollTop() +
                                  o.filter(".selected:last").position().top -
                                  n.innerHeight() +
                                  2 * s
                              );
                        }));
              ...
              !(function () {
                ...
                void 0 === n && (n = q.selectPlaceholder),
                  (void 0 !== i && "" !== i) || (i = q.selectSearch),
                  (void 0 !== o && "" !== o) || (o = q.selectSearchLimit),
                  (void 0 !== r && "" !== r) || (r = q.selectSearchNotFound),
                  void 0 === s && (s = q.selectSearchPlaceholder),
                  (void 0 !== l && "" !== l) || (l = q.selectSmartPositioning);
                var c = P(
                ...
                if (
                  ...
                  m.each(function () {
                    var e = P(this);
                    e.innerWidth() > b &&
                      ((b = e.innerWidth()), (y = e.width()));
                  }),
                  m.css({ display: "" }),
                  u.is(".placeholder") && u.width() > b)
                )
                  u.width(u.width());
                else {
                ...
                var k = c.outerHeight(!0),
                  ...
                  T = m.filter(".selected");
                if (
                  (T.length < 1 && m.first().addClass("selected sel"),
                  void 0 === m.data("li-height"))
                ) {
                  var j = m.outerHeight();
                  !1 !== n && (j = m.eq(1).outerHeight()),
                    m.data("li-height", j);
                }
                var E = h.css("top");
                if (
                  ("auto" == h.css("left") && h.css({ left: 0 }),
                  "auto" == h.css("top") && (h.css({ top: k }), (E = k)),
                  h.hide(),
                  T.length &&
                    (D.first().text() != f.text() && c.addClass("changed"),
                ...
                a.click(function () {
                  if (
                    (P("div.jq-selectbox").filter(".opened").length &&
                      q.onSelectClosed.call(
                        P("div.jq-selectbox").filter(".opened")
                      ),
                    O.focus(),
                    !L)
                  ) {
                    ...
                    var a = function () {
                      h.height("auto").css({ bottom: "auto", top: E });
                      var e = function () {
                        p.css("max-height", Math.floor((o - 20 - C) / n) * n);
                      };
                      e(),
                        p.css("max-height", s),
                        "none" != x && p.css("max-height", x),
                        o < h.outerHeight() + 20 && e();
                    };
                    !0 === l || 1 === l
                      ? r + C + 20 < o
                        ? (a(), c.removeClass("dropup").addClass("dropdown"))
                        : ((function () {
                            h.height("auto").css({ top: "auto", bottom: E });
                            var e = function () {
                              p.css(
                                "max-height",
                                Math.floor((i - t.scrollTop() - 20 - C) / n) * n
                              );
                            };
                            e(),
                              p.css("max-height", s),
                              "none" != x && p.css("max-height", x),
                              i - t.scrollTop() - 20 < h.outerHeight() + 20 &&
                                e();
                          })(),
                      ...
                      : (h.height("auto").css({ bottom: "auto", top: E }),
                        p.css("max-height", s),
                        "none" != x && p.css("max-height", x)),
                      c.offset().left + h.outerWidth() > t.width() &&
                        h.css({ left: "auto", right: 0 }),
                      P("div.jqselect")
                        .css({ zIndex: d - 1 })
                        .removeClass("opened"),
                      c.css({ zIndex: d }),
                      h.is(":hidden")
                        ? (P("div.jq-selectbox__dropdown:visible").hide(),
                          h.show(),
                          c.addClass("opened focused"),
                          q.onSelectOpened.call(c))
                        : (h.hide(),
                          c.removeClass("opened dropup dropdown"),
                          P("div.jq-selectbox").filter(".opened").length &&
                            q.onSelectClosed.call(c)),
                      g.length &&
                        (g.val("").keyup(),
                        v.hide(),
                        g.keyup(function () {
                      ...
                      m.filter(".selected").length &&
                        ("" === O.val()
                          ? p.scrollTop(0)
                          : ((p.innerHeight() / n) % 2 != 0 && (n /= 2),
                            p.scrollTop(
                              p.scrollTop() +
                                m.filter(".selected").position().top -
                                p.innerHeight() / 2 +
                                n
                            ))),
                      S(p);
                ...
                m.filter(":not(.disabled):not(.optgroup)").click(function () {
                  ...
                  if (!e.is(".selected")) {
                    var n = e.index();
                    (n -= e.prevAll(".optgroup").length),
                      e
                        .addClass("selected sel")
                        .siblings()
                        .removeClass("selected sel"),
                      D.prop("selected", !1).eq(n).prop("selected", !0),
                      t,
                      u.text(t),
                      c.data("jqfs-class") &&
                  ...
                  O.on("change.styler", function () {
                    u
                      .text(D.filter(":selected").text())
                      .removeClass("placeholder"),
                      m
                        .removeClass("selected sel")
                        .not(".optgroup")
                        .eq(O[0].selectedIndex)
                        .addClass("selected sel"),
                      D.first().text() != m.filter(".selected").text()
                        ? c.addClass("changed")
                  ...
                  H.registered ||
                    (P(document).on("click", H), (H.registered = !0));
              })();
          };
          r(),
            O.on("refresh", function () {
      ...
      (P.fn[r] = function (t) {
        ...
        return void 0 === t || "object" == typeof t
          ...
          ? (this.each(function () {
              ...
              e instanceof o &&
                "function" == typeof e[t] &&
                (n = e[t].apply(e, Array.prototype.slice.call(i, 1)));
            }),
            void 0 !== n ? n : this)
          : void 0;
      }),
...
function isSafari() {
  var e = window.navigator.userAgent,
    ...
    o = !1;
  t
    ? (o = !!e.match(/WebKit/i) && n && i)
    : (o = void 0 !== window.safari || (n && i));
  return o;
}
(Berserk.settings.gmap_api_key =
  "undefined" != typeof brk && void 0 !== brk.gmap_api_key
    ? brk.gmap_api_key
    : ""),
  (Berserk.settings.recaptcha_api_key =
    "undefined" != typeof brk && void 0 !== brk.recaptcha_api_key
      ? brk.recaptcha_api_key
      : "6Lfsu3QUAAAAAO6j2iAsncliNSQqISfipl0DjPAp"),
  (Berserk.settings.project_prefix =
    "undefined" != typeof brk && void 0 !== brk.shorcodesurl
      ? brk.shorcodesurl
      : ""),
  jQuery.noConflict(),
  ...
  (function () {
    if (!brk_xmode) {
      ...
      location.search.indexOf("dir=rtl") + 1
        ? (document.documentElement.setAttribute("dir", "rtl"),
          e.setAttribute("href", "css/assets/bootstrap-rtl.css"),
          t.setAttribute("href", "css/assets/offsets-rtl.css"),
          n.length && (n[0].style.direction = "ltr"))
        : location.search.indexOf("dir=ltr") + 1 &&
          (document.documentElement.setAttribute("dir", "ltr"),
          e.setAttribute("href", "css/assets/bootstrap.css"),
          t.setAttribute("href", "css/assets/offsets.css"));
    }
  })(),
  (function (a) {
    isSafari() && a("html").addClass("brk-safari"),
      ...
      (Berserk.attachBehaviors = function (e, t) {
        (e = e || document),
          (t = t || Berserk.settings),
          a.each(Berserk.behaviors, function () {
      ...
      a(function () {
        Berserk.attachBehaviors(a("body"), Berserk.settings),
          (function () {
            if (
              (a("[data-brk-library]:not(.brk-library-rendered)")
              ...
              var e,
                t = "",
                n = "";
              for (r in (brk_xmode && (n = 'class="brk-css-add" '), s.css))
                (e =
                  Berserk.settings.project_prefix &&
                  -1 === s.css[r].indexOf("//")
                    ? Berserk.settings.project_prefix
                    : ""),
                  console.log("CSS added: " + e + s.css[r]),
                  (t +=
                    "<link " +
                    n +
                    'rel="stylesheet"  href="' +
              ...
              for (r in s.js)
                (e =
                  ...
                  -1 === s.js[r].indexOf("//")
                    ? Berserk.settings.project_prefix
                    : ""),
                  console.log("JS added: " + e + s.js[r]),
                  a.cachedScript(e + s.js[r], {
                    success: function (e, t) {
                      (o += 1),
                        Object.keys(s.js).length === o &&
                          (Berserk.attachBehaviors(a("body"), Berserk.settings),
                          (s = { css: {}, js: {} }));
                    },
                  });
          ...
          a(document).on("trigger-behaviors", function (e) {
            Berserk.attachBehaviors(a(".trigger-behaviors"), Berserk.settings),
              a(".trigger-behaviors").removeClass("trigger-behaviors");
          });
      }),
      a(function () {
        var n = [],
    ...
    (a.fn.isOnScreen = function (e) {
      ...
      return "function" == typeof e
        ? e(s)
        : 0 < s.top - t && 0 < s.left && 0 < s.right && 0 < s.bottom - t;
    }),
      (a.fn.isAppearOnScreen = function (e) {
        ...
        return "function" == typeof e
          ? e(s)
          : 0 < s.top && 0 < s.left && 0 < s.right && 0 < s.bottom;
      }),
    ...
    e.length &&
      ...
      window.addEventListener("load", function () {
        a("a:not(.nohash-animat)").on("click", function (e) {
          ...
          if (
            "" !== this.hash &&
            "#top" !== this.hash &&
            "collapse" !== this.getAttribute("data-toggle") &&
            "tab" !== this.getAttribute("data-toggle") &&
            !a(this).hasClass("fancybox") &&
            !a(this).parent().parent().get(0).getAttribute("data-tabgroup") &&
            "#" === t[0]
          ) {
            e.preventDefault();
            var n = this.hash;
        ...
        attach: function (e, t) {
          a('a[href="#top"]').each(function () {
            ...
            a(window).on("scroll", function () {
              e.is('[id="toTop"]') &&
                (150 < a(this).scrollTop() ? e.fadeIn() : e.fadeOut());
            }),
              e.on("click", function () {
                return a("body, html").animate({ scrollTop: 0 }, 300), !1;
              });
          });
        },
      }),
      (Berserk.behaviors.border_theme_init = {
        attach: function (e, t) {
          a("body").hasClass("brk-bordered-theme")
            ? a(":root").attr(
                "style",
                "--b-radius: " + a("body").attr("data-border") + "px;"
              )
            : a(":root").attr("style", "--b-radius:;");
        },
      }),
          ...
          (n = jQuery).fn.counter = function (r) {
            ...
            setTimeout(function () {
              !(function e(t, n, i) {
                ...
                i <= o
                  ? (t.html(Math.round(i)), r.callback())
                  : (t.html(Math.round(o)),
                    setTimeout(function () {
                      e(t, n, i);
                    }, r.step));
    ...
    (Berserk.behaviors.fancybox_init = {
      attach: function (e, t) {
        if (
          !(
            a(".fancybox:not(.rendered), .fancybox-media:not(.rendered)")
              .length < 1
          )
        ) {
          if (void 0 === a.fn.fancybox)
            return (
              console.log("Waiting for the fancybox library"),
              void setTimeout(Berserk.behaviors.fancybox_init.attach, 200, e, t)
            );
      ...
      "function" == typeof a.UItoTop &&
        a().UItoTop({ text: "", min: 200, inDelay: 0, outDelay: 0 });
    var s = { css: {}, js: {} },
      l = {},
      t = {
      ...
      c = {
        ...
        twitter_init: { js: ["js/assets/twitter-init.js"] },
        recaptcha: {
          js: [
      ...
      if (void 0 !== n[e]) {
        if (void 0 !== n[e].dependency)
          for (r in n[e].dependency)
            void 0 === l[n[e].dependency[r]] &&
              ((l[n[e].dependency[r]] = 1), u(n[e].dependency[r]));
        if (void 0 !== n[e].css)
          for (r in n[e].css)
            t[n[e].css[r]] ||
              ((t[n[e].css[r]] = !0), (s.css[n[e].css[r]] = n[e].css[r]));
        if (void 0 !== n[e].js)
          for (r in n[e].js)
            t[n[e].js[r]] ||
              ((t[n[e].js[r]] = !0), (s.js[n[e].js[r]] = n[e].js[r]));
      }
    }
    a(document).ready(function () {
      a.each(c, function (e, t) {
        a(
          '[data-brk-library*="' + e + '"]:not(.lazyloaded):not(.lazyload)'
        ).addClass("lazyload");
      });
    }),
        ...
        t &&
          (function (e) {
            ...
            for (var i in t)
              if (c[t[i]]) {
                if (void 0 !== c[t[i]].js)
                  for (var o in c[t[i]].js)
                    d[c[t[i]].js[o]] ||
                      ((d[c[t[i]].js[o]] = !0),
                      (n =
                        Berserk.settings.project_prefix &&
                        -1 === c[t[i]].js[o].indexOf("//")
                          ? Berserk.settings.project_prefix
                          : ""),
                      console.log("JS added: " + n + c[t[i]].js[o]),
                      a.cachedScript(n + c[t[i]].js[o], {
                        success: function (e, t) {
                          Berserk.attachBehaviors(a("body"), Berserk.settings);
                        },
                      }));
                if (void 0 !== c[t[i]].css)
                  for (o in c[t[i]].css)
                    d[c[t[i]].css[o]] ||
                      ...
                      (n =
                        Berserk.settings.project_prefix &&
                        -1 === c[t[i]].css[o].indexOf("//")
                          ? Berserk.settings.project_prefix
                          : ""),
                      console.log("CSS added: " + n + c[t[i]].css[o]),
                      a("head").append(
    ...
    var n = {
      ...
      waypoints: { js: ["vendor/waypoints/js/jquery.waypoints.min.js"] },
      "pe-icon-7": {
      ...
      slider__rotator: { js: ["js/assets/rotation-slider.js"] },
      jquerySlider: { js: ["vendor/jquerySlider/js/jquery-ui.min.js"] },
      isotope: { js: ["vendor/isotope/js/isotope.pkgd.min.js"] },
      datatables_js: { js: ["vendor/datatables/js/jquery.dataTables.min.js"] },
      scrollbar: {
        css: ["vendor/jquery.scrollbar/css/jquery.scrollbar.css"],
        js: ["vendor/jquery.scrollbar/js/jquery.scrollbar.min.js"],
      },
      assets_particleground: { js: ["js/assets/jquery.particleground.min.js"] },
      assets_fss: { js: ["js/assets/fss.min.js"] },
      assets_skrollr: { js: ["js/assets/skrollr.min.js"] },
      paper: { js: ["vendor/paper/js/paper-full.js"] },
      anime: {
      ...
      odometer: { js: ["vendor/odometer/js/odometer.min.js"] },
      typewriter: { js: ["vendor/typewriter/js/core.js"] },
      jqueryAutocomplete: {
        css: ["vendor/jqueryAutocomplete/css/jquery-ui.css"],
        js: ["vendor/jqueryAutocomplete/js/jquery-ui.min.js"],
      },
      assets__typing_rotator: { js: ["js/assets/typing-rotator.js"] },
      ...
      flexmenu: { js: ["js/assets/flexmenu.js"] },
      component__social_links: { css: ["css/components/social-links.css"] },
      component__breadcrumbs_css: { css: ["css/components/breadcrumbs.css"] },
      component__breadcrumbs_js: { js: ["js/components/breadcrumbs.js"] },
      ...
      component__sliders_css: { css: ["css/components/sliders.css"] },
      ...
      component__social_block: { css: ["css/components/social.css"] },
      component__flip_box_css: { css: ["css/components/flip-boxes.css"] },
      component__flip_box: { dependency: ["component__flip_box_css"] },
      component__app_showcase: { css: ["css/components/flip-boxes.css"] },
      component__title: { css: ["css/components/titles.css"] },
      component__typing_rotator: { css: ["css/components/typing-rotator.css"] },
      component__dividers: { css: ["css/components/dividers.css"] },
      ...
      component__forum_post: { css: ["css/components/forum-post.css"] },
      component__forum_main: { css: ["css/components/forum-main.css"] },
      component__forum_author: { css: ["css/components/forum-author.css"] },
      ...
      component__image_frames: { css: ["css/components/image-frames.css"] },
      component__info_box: {
      ...
      component__list: { css: ["css/components/lists.css"] },
      component__panel: { css: ["css/components/panels.css"] },
      component__pricing_table: { css: ["css/components/pricing-tables.css"] },
      component__blog_css: { css: ["css/components/blog.css"] },
      component__blog_js: { js: ["js/components/blog.js"] },
      component__blog: {
        js: ["js/components/blog.js"],
        dependency: ["slider__slick", "component__blog_css"],
      },
      component__blog_grid: { css: ["css/components/blog-grid.css"] },
      component__blog_page_css: { css: ["css/components/blog-page.css"] },
      ...
      component__widgets_css: { css: ["css/components/widgets.css"] },
      component__widgets: {
        js: ["js/components/widgets.js"],
        dependency: ["component__widgets_css", "slider__slick"],
      },
      component__winter: { css: ["css/components/winter.css"] },
      ...
      component__team_page_css: { css: ["css/components/team-member.css"] },
      ...
      component__portfolio_list: { css: ["css/components/portfolio-list.css"] },
      ...
      component__sequence: { css: ["css/components/sequence.css"] },
      component__services: { css: ["css/components/services.css"] },
      ...
      component__testimonials: { css: ["css/components/testimonials.css"] },
      component__tiles: { css: ["css/components/tiles.css"] },
      component__icons: {
        css: ["css/components/icons.css"],
        js: ["js/components/icons.js"],
      },
      component__title_section: { css: ["css/components/section-titles.css"] },
      component__delimiters: { css: ["css/components/delimiters.css"] },
      component__backgrounds_css: { css: ["css/components/backgrounds.css"] },
      component__backgrounds_js: { js: ["js/components/backgrounds.js"] },
      ...
      component__tags: { css: ["css/components/tags.css"] },
      component__tags_js: { js: ["js/components/tags.js"] },
      component__timelines_css: { css: ["css/components/timelines.css"] },
      component__timelines: {
        dependency: ["component__timelines_css", "component__content_slider"],
      },
      component__timelines_js: { js: ["js/components/timelines.js"] },
      ...
      component__shop_row: { css: ["css/components/shop-components-row.css"] },
      ...
      component__shop_grid: { dependency: ["component__flip_box"] },
      ...
      component__svg_pattern: { css: ["css/components/svg-pattern.css"] },
      component__gallery: {
      ...
      component__checkout: { css: ["css/components/checkout.css"] },
      component__map: { css: ["css/components/google-maps.css"] },
    };
    window.xMode
      ? (a("html").removeClass("brk-preloader"),
        a(".brk-header:not(.brk-header_vertical)")
          .css("display", "")
          .addClass("d-flex"))
      ...
      window.xMode &&
        (a("head").append('<link rel="stylesheet" href="css/assets/novi.css">'),
        a(".flip-box").on("dblclick", function () {
  ...
  (function (m) {
    ...
    m(document).ready(function () {
      ...
      var o = m(".brk-theme-options__color").find(
    ...
    //     var e = m(this),
    //       t = e.data("skin");
    //     s.indexOf(t + ".css") + 1 && e.addClass("checked"),
    //       e.on("click", function () {
    //         r.attr(
    //           "href",
    //           Berserk.settings.project_prefix + "css/skins/" + t + ".css"
    //         ),
    //           o.removeClass("checked"),
    //           e.addClass("checked"),
    //           m("html").data("brk-skin", t + ".css");
    //       });
    //   });
      ...
      a.each(function () {
        ...
        t === m("html").attr("dir") &&
          (l.removeClass("brk-theme-options__check_active"),
          n.addClass("brk-theme-options__check_active"));
      });
      ...
      c.each(function () {
        ...
        n.on("click", function (e) {
          ...
          d.removeClass("brk-theme-options__check_active"),
            i.addClass("brk-theme-options__check_active"),
            0 !== t
              ? m("body").addClass("brk-bordered-theme").attr("data-border", t)
              : m("body")
                  .removeClass("brk-bordered-theme")
                  .removeAttr("data-border"),
            Berserk.behaviors.border_theme_init.attach(m(document));
        });
      });
      ...
      u.each(function () {
        ...
        n.on("click", function (e) {
          ...
          f.removeClass("brk-theme-options__check_active"),
            i.addClass("brk-theme-options__check_active"),
            "boxed" === t
              ? m("body").addClass("brk-boxed")
              : m("body").removeClass("brk-boxed");
        });
      });
      ...
      attach: function (e, t) {
        j(e)
          ...
          .each(function () {
                    ...
                    if (e <= (window.innerWidth || j(window).width())) {
                      if (a.length) {
                        ...
                        if (0 < j(window).scrollTop())
                          if (
                            (j(".brk-open-top-bar").length &&
                              d.find(".brk-open-top-bar").removeClass("active"),
                            j("body").hasClass("admin-bar"))
                          ) {
                            var n = t - 32;
                            d.css("top", "-" + n + "px");
                          } else d.css("top", "-" + t + "px");
                          ...
                          j(window).scrollTop() <= 0 &&
                            (j(".brk-open-top-bar").length &&
                              d.find(".brk-open-top-bar").addClass("active"),
                            j("body").hasClass("admin-bar")
                              ? d.css("top", "32px")
                              : d.css("top", "0"));
                      }
            ...
            if (
              j(".brk-open-top-bar").length &&
              !d.find(".brk-header__top-bar_scroll").length
            ) {
            ...
            function c(e) {
              ...
              d.hasClass("brk-header_not-fixed") ||
                (e <= t &&
                  (0 < j(window).scrollTop()
                    ? (d.addClass("brk-header_scroll"),
                      o && i.css("height", o + "px"))
                    : j(window).scrollTop() <= 0 &&
                      (d.removeClass("brk-header_scroll"),
                      o && i.css("height", n + "px")))),
                0 < j(window).scrollTop()
                  ? j(".brk-header-mobile").addClass("brk-header-mobile_scroll")
                  : j(window).scrollTop() <= 0 &&
                    j(".brk-header-mobile").removeClass(
            ...
            if (
              (j(window).on("scroll", function () {
                if (
                  d.find(".brk-header__top-bar_scroll") &&
                  0 < j(window).scrollTop()
                ) {
              ...
              setTimeout(function () {
                j(window).on("scroll", function () {
                  ...
                  0 < e &&
                    (u < e
                      ? ((t = !1),
                        e < d.height() + d.offset().top &&
                          !1 === n &&
                          (d.addClass("brk-header_sticky-hide"), (n = !0)))
                      : ((n = !1),
                        e > d.offset().top &&
                          !1 === t &&
                          (d.removeClass("brk-header_sticky-hide"), (t = !0))),
                    (u = e));
                });
              }, 2500);
            }
            ...
            function h(e) {
              ...
              if (t < e && !f) {
                d.wrap(
                  '<div class="brk-header-mobile-wrap"><div class="brk-header-mobile-wrap__body"></div></div>'
                );
                var n = j(".brk-header-mobile-wrap"),
                  ...
                  r = d.data("bg-mobile");
                i.prepend(
                  '<div class="brk-before"></div><div class="brk-header-mobile-wrap__header"><div class="brk-header-mobile-wrap__close"><span></span></div></div>'
                ),
                  "" !== o &&
                    j(".brk-header-mobile-wrap__header").prepend(
                  ...
                  n.before('<div class="brk-header-mobile-wrap-layer"></div>'),
                  (f = !0);
              ...
              var s = j(".brk-header-mobile"),
                ...
                l = (n = j(".brk-header-mobile-wrap")).find(
                  ".brk-header-mobile-wrap__close"
                ),
                c = j(".brk-header-mobile-wrap-layer");
              s.length &&
                a.on("click", function () {
                  j("body").addClass("brk-modal-open"),
                    ...
                    e.on("click", function (e) {
                      if ((e.preventDefault(), j(n).length)) {
                        ...
                        j("body").removeClass("brk-modal-open"),
                          ...
                          j(".brk-header-mobile-wrap-layer").removeClass(
                            "is-active"
                          );
                      }
                    });
              ...
              j(".brk-quantity")
                ...
                .on("click", function () {
                  var e = j(this).parent().find(".brk-quantity__value"),
                    t = e.val();
                  j(this).hasClass("minus") && 1 < t
                    ? e.val(+t - 1)
                    : j(this).hasClass("plus") && e.val(+t + 1);
                });
            ...
            function C(e) {
              var t = window.innerWidth || j(window).width();
              t < e
                ? j(".brk-lang:not(.brk-lang-rendered)")
                    ...
                    .each(function () {
                      ...
                      t.css({
                        ...
                        e.on({
                          mouseenter: function () {
                            i.css("opacity", "0"),
                              n.css("background", "transparent !important"),
                              t.addClass("top-bar-bg"),
                              j("div").is(".brk-overlay") ||
                                d.after('<div class="brk-overlay"></div>'),
                              o.css("border", "0");
                          },
                          mouseleave: function () {
                            i.css("opacity", "1"),
                              n.removeAttr("style"),
                              t.removeClass("top-bar-bg"),
                              j("div").is(".brk-overlay") &&
                                j(".brk-overlay").remove(),
                              o.css("border", "");
                          },
                        });
                    })
                    .removeClass("brk-lang-rendered"),
                  j(".brk-lang__option").css("display", ""),
                  j(".brk-lang").find(".brk-lang__open").unbind("click"));
            }
            function x() {
            ...
            v.on("click", function () {
              g.toggleClass("active"),
                v.toggleClass("open-active"),
                992 <= y &&
                  (_.toggleClass("brk-modal-open"),
                  _.hasClass("brk-modal-open")
                    ? _.attr("style", "--mr:" + w + "px")
                    : _.attr("style", ""));
            }),
              b.on("click", function () {
                g.hasClass("active") && g.removeClass("active"),
                  v.hasClass("open-active") && v.removeClass("open-active"),
                  992 <= y &&
                    (_.hasClass("brk-modal-open") &&
              ...
              j(document).on("click", function (e) {
                j(e.target).closest(".brk-info-menu").length ||
                  j(e.target).closest(".brk-info-menu-open").length ||
                  (g.hasClass("active") && g.removeClass("active"),
                  v.hasClass("open-active") && v.removeClass("open-active"),
                  992 <= y &&
                    (_.hasClass("brk-modal-open") &&
              ...
              k(".brk-search", ".brk-search__open", ".brk-search__block", 992),
              j(window).on("resize", function () {
                k(
                  ".brk-mini-cart",
                  ".brk-mini-cart__open, .brk-mini-cart__info-open",
              ...
              992 <= (window.innerWidth || j(window).width()) &&
                j(".brk-search_interactive").each(function () {
                  var e = j(this),
                  ...
                  i.on("click", function () {
                    ...
                    o.on("click", function () {
                      r.removeClass("active"),
                        a.show(0),
                        i.show(0),
                        n.removeClass("position-relative"),
                        j("div").is(".brk-overlay") &&
                          j(".brk-overlay").remove(),
                        l.css("border", "");
                    }),
                    j(document).on("click", function (e) {
                      j(e.target).closest(".brk-header").length ||
                        (r.removeClass("active"),
                        a.show(0),
                        i.show(0),
                        n.removeClass("position-relative"),
              ...
              (function () {
                if (0 < j(".brk-header-popup-menu").length) {
                  ...
                  var t = j(".brk-header-popup-menu").find(
                      ".brk-header-popup-menu__open-close"
                    ),
                    n = j(".brk-header-popup-menu__menu"),
                    i = j(".brk-header-popup-menu-layer"),
                    o = n.find("a");
                  0 < j(".brk-header_vertical").length &&
                    (j(".brk-header").append(n), n.addClass("brk-moved-by-js")),
                    t.on("click", function () {
      ...
      (Berserk.behaviors.header_init_menu_flex = {
        attach: function (e, t) {
          if (!(j(".brk-nav:not(.rendered)").length < 1)) {
            if ("function" != typeof j.fn.flexMenu)
              return (
            ...
            j(e)
              ...
              .each(function () {
                ...
                0 === e.closest(".brk-header_vertical").length &&
                  ((n = n || "More"),
                  j(window).on("load", function () {
          ...
          function o(t, e) {
            var n = window.innerWidth || j(window).width();
            n < 992 && !i
              ? (t.flexMenu({ undo: !0 }), (i = !0))
              : 992 <= n &&
                i &&
                (t.flexMenu({ linkText: e }),
                setTimeout(function () {
                  if (j(".flexMenu-viewMore").length) {
                    var e = j(".flexMenu-popup").offset().left + 80;
                    t.find(".flexMenu-viewMore .brk-nav__mega-menu").attr(
                      "style",
      ...
      attach: function (e, t) {
        function p(e, t) {
          e.width(t.innerWidth())
            ...
            .data("origWidth", e.innerWidth());
        }
        m(".brk-tabs:not(.rendered)", e)
          .addClass("rendered")
          .each(function () {
            var o, n, i, e, t, r, s;
            if (m(this).hasClass("brk-tabs-hovers")) {
              (e = (o = m(this)).find(".brk-tabs-nav")),
                (n = o.find(".brk-tab")),
                (i = o.find(".brk-tab-item")),
                (s = o.data("index"));
              ...
              if (
                ((s = s || 0),
                a[0]
                  ? o.addClass("brk-tabs-hovers_style-1")
                  : l[0]
                  ? o.addClass("brk-tabs-hovers_style-2")
                  : c[0] && o.addClass("brk-tabs-hovers_style-3"),
                a[0] &&
                  e.append(
              ...
              (o = m(this)),
                ...
                n
                  ...
                  .addClass("active");
            if (
              m(this).hasClass("brk-tabs-simple-top") ||
              m(this).hasClass("brk-tabs-simple-bottom") ||
              m(this).hasClass("brk-tabs-bottom-top") ||
              m(this).hasClass("brk-tabs-bottom-bottom") ||
              m(this).hasClass("brk-tabs-parallax") ||
              m(this).hasClass("brk-tabs_tabbed-filter")
            ) {
              (r = (o = m(this)).find(".brk-tabs-nav")),
                (n = o.find(".brk-tab")),
                (t = o.find(".brk-tab.active")),
                r.append("<span class='magic-line'></span>");
              ...
              m(window).on("load", function () {
                ...
                n.on("click", function () {
                  if (n.hasClass("active")) {
                    ...
                    h.width(e.innerWidth())
                      .css("left", e.position().left)
                      .data("origLeft", h.position().left)
                      .data("origWidth", h.innerWidth());
                  }
                }),
                n.on({
                  mouseenter: function () {
              ...
              r(this)
                .on("mouseenter", function (e) {
                  var t = r(this).offset(),
                    n = e.pageX - t.left,
                    i = e.pageY - t.top;
                  r(this).find("span").css({ top: i, left: n });
                })
              ...
              r(this)
                .on("mouseenter", function (e) {
                  var t = r(this).offset(),
                    n = e.pageX - t.left,
                    i = e.pageY - t.top;
                  r(this).find(".slide-bg").css({ top: i, left: n });
                })
                .on("mouseout", function (e) {
                  var t = r(this).offset(),
                    n = e.pageX - t.left,
          ...
          r(e)
            ...
            .each(function () {
              var e = r(this),
                t = e.attr("style") || "",
                o = "";
              t && (e.data("brk-btn-style", t), (o = e.data("brk-btn-style"))),
      ...
      return (
        this.each(function () {
          ...
          r(this).addClass("rendered"),
            (t = void 0 !== e.attr("placeholder") && e.attr("placeholder")),
            e.removeAttr("placeholder"),
            void 0 !== e.attr("id")
              ? (n = e.attr("id"))
              : ((n = "brkin-" + o), e.attr("id", n)),
            e.wrap(function () {
              return '<div class="' + i.formWrap + '"></div>';
            }),
            void 0 === e.attr("readonly") &&
              !1 !== t &&
              e
                .parent()
                .append(
            ...
            "" !== e.val() &&
              void 0 === e.attr("readonly") &&
              e.parent().addClass(i.formWrapActive),
            e.on("focus", function () {
              void 0 === e.attr("readonly") &&
                e.parent().addClass(i.formWrapActive);
            }),
  ...
  (function (s) {
    Berserk.behaviors.form_controls = {
      attach: function (e, t) {
        ...
        0 !== i.length &&
          0 === o.length &&
          s(e).parent().find("select:not(.rendered)").styler(),
          (n = s(e).parent().find('[type="date"]:not(.rendered)')).each(
            function () {
              var e = s(this);
              s(this).addClass("rendered"),
                e.wrap(function () {
          ...
          s(e)
            ...
            .each(function () {
              ...
              s(this).addClass("rendered"),
                "file" === n.attr("type") &&
                  (n.parents().hasClass("brk-form-strict")
                    ? (n.wrap(function () {
                    ...
                    : n.parents().hasClass("brk-form-round")
                    ? (n.wrap(function () {
                        return '<label class="' + e + '"></label>';
                      }),
                      n
                    ...
                    : n.parents().hasClass("brk-form-transparent") &&
                      (n.wrap(function () {
            ...
            .each(function () {
              ...
              s(this).addClass("rendered"),
                "radio" === e.attr("type") &&
                  ...
                  e.parents().hasClass("brk-form-transparent")
                    ? e
                        .parent()
                        .append(
                          '<span class="radio-custom"><i class="fa fa-check" aria-hidden="true"></i></span>'
                        )
                    : e.parent().append('<span class="radio-custom"></span>'));
            }),
          s(".brk-subscribe-mail:not(.rendered)")
            .addClass("rendered")
            .each(function () {
              var n = s(this);
              n.on("submit", function (e) {
                ...
                s.getJSON("php/subscribe.php", t, function (e) {
                  ...
                  n.append(t),
                    setTimeout(function () {
                      n.find(".brk-subscribe-message").fadeOut(),
                        n.trigger("reset");
                    }, 3e3);
                });
              });
        ...
        r.on("focus", function () {
          s(this).data("placeholder", s(this).attr("placeholder")),
  ...
  (function (a) {
    ...
    Berserk.behaviors.media_embeds_init = {
      attach: function (e, t) {
        var n, i, o, r, s;
        a(".fb-video:not(.rendered)", e).addClass("rendered").length &&
          ((n = document),
          (i = "script"),
          (o = "facebook-jssdk"),
          (s = n.getElementsByTagName(i)[0]),
          n.getElementById(o) ||
            (((r = n.createElement(i)).id = o),
            (r.src =
              "https://connect.facebook.net/uk_UA/sdk.js#xfbml=1&version=v2.11"),
            s.parentNode.insertBefore(r, s))),
          a(".brk-hosted-video:not(.rendered)", e)
            .addClass("rendered")
            .each(function (e) {
              var t = a(this).find(".brk-hosted-video__btn"),
                n = a(this).find("video");
              a(this).hasClass("brk-hosted-video_inner") &&
                (t.attr("href", "#brk-hosted-video-" + e),
                n.attr("id", "brk-hosted-video-" + e));
            });
      },
    };
  })(jQuery),
    ...
    Berserk.behaviors.image_map_init = {
      attach: function (e, t) {
        if (!(i(".brk-image-map:not(.rendered)").length < 1)) {
          if ("function" != typeof i.fn.imageMapPro)
            return (
  ...
  (function (r) {
    ...
    (Berserk.behaviors.footer_init = {
      attach: function (e, t) {
        if (
          (r(".brk-footer__wrapper:not(.rendered)", e).each(function () {
            if (r(this).hasClass("brk-footer__wrapper_animated")) {
              var e = r(this),
                ...
                o = function () {
                  t
                    .css("height", e.outerHeight(!0))
                    .addClass("brk-footer_animated"),
                    n
                      .css("margin-bottom", e.outerHeight(!0))
              ...
              i >= e.outerHeight(!0) &&
                ...
                r(this).on("DOMSubtreeModified", function () {
                  e.outerHeight(!0) !== t.outerHeight(!0) &&
                    i >= e.outerHeight(!0) &&
                    o();
                }),
      ...
      (Berserk.behaviors.footer_scrollr_init = {
        attach: function (e, t) {
          if (r("[data-skrollr]:not(.skrollr-rendered)").length) {
            ...
            992 <= (window.innerWidth || r(window).width()) &&
              (r("[data-skrollr]:not(.skrollr-rendered)").addClass(
                "skrollr-rendered"
              ),
              setTimeout(function () {
            ...
            n.each(function () {
              ...
              function l(e) {
                992 < e
                  ? ((n = 100 / s + "%"),
                    (i = (100 / s) * 2 + "%"),
                    r.find(".brk-grid__sizer").css("width", n),
                    r.find(".brk-grid__item").css("width", n),
                    r.find(".brk-grid__item_width-2").css("width", i))
                  : e <= 992 && t
                  ? ((n = 100 / t + "%"),
                    (i = (100 / t) * 2 + "%"),
                    r.find(".brk-grid__sizer").css("width", n),
              ...
              r.attr("data-grid-cols-tablet") &&
                ...
                c(".brk-filters:not(.rendered)", e)
                  ...
                  .each(function () {
                    ...
                    n &&
                      "*" !== n &&
                      ((e = r.find(n).length),
                      t.find(".brk-filters__count").html(e)),
                      n &&
                        "*" === n &&
                        ((e = r.find(".brk-grid__item").length),
                        t.find(".brk-filters__count").html(e));
                  }),
                c(".brk-filters:not(.rendered)", e).on(
                  "click",
                  "li",
                  function () {
                ...
                c(".brk-filters:not(.rendered)", e).addClass("rendered"),
                c(e)
                  .parent()
                  ...
                  if (
                    ...
                    e.css({ width: n + "%" }),
                      e
                        ...
                        .removeClass("hide")
                        .counter({ start: t, end: n, time: 0.7, step: 50 }),
                      e.addClass("scrolled");
            ...
            a(window).on("scroll", function () {
              i.not(".scrolled").each(function () {
                var e = a(this).offset().top,
                  ...
                  o = n.find("path");
                e < t &&
                  (o.css({ "stroke-dashoffset": 153 - 153 * i + "%" }),
                  n.addClass("scrolled"));
              });
            }),
            window.addEventListener("load", function () {
            ...
            a(window).on("scroll", function () {
              o.not(".scrolled").each(function () {
                var e = a(this).offset().top,
                  ...
                  s = (100 * i) / o + "%";
                e < t && (r.css({ width: s }), n.addClass("scrolled"));
              });
            });
        }
      },
    ...
    Berserk.behaviors.portfolio_rows_init = {
      attach: function (e, t) {
        if (
          ...
          if (
            ("function" != typeof Isotope &&
              "function" != typeof l.fn.brk_hover3d) ||
            "function" != typeof anime
          )
            return (
              console.log(
          ...
          a.each(function () {
            ...
            var s = function (e) {
              992 < e
                ? ((n = 100 / o + "%"),
                  (i = (100 / o) * 2 + "%"),
                  a.find(".brk-grid-fitrows__item").css("width", n),
                  a.find(".brk-grid-fitrows__item_width-2").css("width", i))
                : e <= 992 && t
                ? ((n = 100 / t + "%"),
                  (i = (100 / t) * 2 + "%"),
                  a.find(".brk-grid-fitrows__item").css("width", n),
            ...
            s(e),
              ...
              a.find(".brk-grid-fitrows__item").css("height", r),
              setTimeout(function () {
                new Isotope(a.get(0), {
            ...
            l(".brk-simple-card-2:not(.rendered)", e)
        ...
        n.length &&
          n.each(function () {
            ...
            var t = e.parent().siblings(".tabgroup"),
              c = e.find(">li>a");
            t.find(">div").hide(),
              t.find(d(e.find(">li>a.active").attr("href"))).show(),
              c.on("click", function (e) {
                var t = d(this),
                  n = "#" + t.parents(".tabs").data("tabgroup"),
                  i = t.closest("li").siblings().children("a"),
                  o = t.attr("href") || null;
                (null !== o && 0 !== o.length && "#" !== o[0]) ||
                  (e.preventDefault(),
                  c.parent().removeClass("complete"),
                  t.parent().prevAll().addClass("complete"),
                  t.parent().nextAll().removeClass("complete"),
                  t.parent().addClass("complete"),
                  i.removeClass("active"),
                  t.addClass("active"),
                  d(n).children("div").hide(),
                  d(o).show(),
                  r.length && a(),
                  s.length && l());
              });
    ...
    Berserk.behaviors.parallax_video_init = {
      attach: function (e, t) {
        if (
          ...
          if (void 0 === jQuery.mbYTPlayer || void 0 === jQuery.vimeo_player)
            return (
          ...
          var n;
          (n = []),
            o(".vimeo-video:not(.rendered) iframe").each(function () {
              (n[i] = new Vimeo.Player(o(this))), n[i].setVolume(0);
            }),
            o(".vimeo-video").addClass("rendered"),
            window.addEventListener("load", function () {
              o(function () {
                o(".player-yt:not(.rendered)", e)
                  .addClass("rendered")
                  .each(function () {
                    o(this).YTPlayer(o(this).data("options")),
                      o(this)
                        .on("YTPPlay", function () {
                ...
                o(function () {
                  o(".player-vimeo:not(.rendered)", e)
                    .addClass("rendered")
                    .each(function () {
                      o(this).vimeo_player(o(this).data("options")),
                        o(this)
                          .on("VPPlay", function () {
                            o(this)
      ...
      attach: function (e, t) {
        ...
        n.length &&
          n.each(function () {
            ...
            if (e.parents(".counter__wrapper-filled").length)
              var r = e.parents(".counter__wrapper-filled").find("svg circle"),
            ...
            e.waypoint({
              handler: function () {
                e.hasClass("init") ||
                  (e.parents(".counter__wrapper-filled").length &&
                    r.css({
                      "stroke-dashoffset": c,
                  ...
                  d({ countNum: o }).animate(
                    { countNum: n },
                    {
                      duration: i,
                      easing: "linear",
                      step: function () {
                        e.html(Math.floor(this.countNum)),
                          e.html(function (e, t) {
                            return t.replace(/(\d)/g, "<span>$1</span>");
                          });
                      },
                      complete: function () {
                        e.html(this.countNum),
                          e.html(function (e, t) {
                            return t.replace(/(\d)/g, "<span>$1</span>");
                          }),
                          e.addClass("init");
  ...
  (function (n) {
    ...
    Berserk.behaviors.sliders_page_init = {
      attach: function (e, t) {
        if (!(n(".brk-carousel_project:not(.rendered)").length < 1))
          return void 0 === n.fn.slick
            ? (console.log("Waiting for the slick library"),
              void setTimeout(
                ...
                .each(function () {
                  ...
                  s.on("click", function () {
                    ...
                    t.on("init afterChange", function (e, t, n, i) {
                      o.text(t.currentSlide + 1),
                        0 === t.currentSlide
                          ? s.addClass("brk-carousel__btn-prev_disabled")
                          : s.removeClass("brk-carousel__btn-prev_disabled"),
                        t.currentSlide + 1 === t.slideCount
                          ? a.addClass("brk-carousel__btn-next_disabled")
                          : a.removeClass("brk-carousel__btn-next_disabled");
                    }),
                    t.slick({
                      dots: !1,
                      prevArrow: !1,
            ...
            .slider({
              ...
              slide: function (e, t) {
                for (var n = 0; n < t.values.length; ++n)
                  i("input.sliderValue[data-index=" + n + "]").val(t.values[n]);
              },
            }),
      ...
      i(window).on("load", function () {
        i("#filter-trigger").each(function () {
          ...
          i("button#categories-list-trigger").on("click", function () {
            ...
            e.querySelector("#filter-trigger").classList.add("closed"),
              e.querySelector(".filter").classList.add("closed");
          });
      });
  })(jQuery),
  (function (d) {
      ...
      attach: function (e, t) {
        ...
        n.length &&
          n.each(function () {
            ...
            (e = isNaN(parseFloat(i)) ? 1e3 : i),
              (n = isNaN(parseFloat(o)) ? 1e3 : o);
          ...
          d(e).parent().find(".info-box__wrapper-icon:not(.rendered)").length &&
            d(".info-box__wrapper-icon").each(function () {
              d(this).addClass("rendered");
              var e = d(this),
                t = e.find("svg").clone();
  ...
  (function (s) {
    ...
    Berserk.behaviors.tiles_angle_init = {
      attach: function (e, t) {
        s(".brk-sc-tiles-angle:not(.rendered)").length < 1 ||
          (992 <= (window.innerWidth || s(window).width()) &&
            s(e)
              .parent()
              ...
              .each(function () {
                ...
                o.on({
                  mouseenter: function () {
                    s(this).siblings(i).addClass("no-active"),
                      s(this).siblings(t).addClass("top-active");
                  },
                  mouseleave: function () {
                    s(this).siblings(i).removeClass("no-active"),
                      s(this).siblings(t).removeClass("top-active");
                  },
                }),
                  r.on({
                    mouseenter: function () {
                      s(this).siblings(n).addClass("no-active"),
                        s(this).siblings(t).addClass("bottom-active");
                    },
                    mouseleave: function () {
                      s(this).siblings(n).removeClass("no-active"),
                        s(this).siblings(t).removeClass("bottom-active");
                    },
                  });
              }));
      },
  ...
  (function (e) {
    "use strict";
    Berserk.behaviors.blog__page_init = { attach: function (e, t) {} };
  })(jQuery);
